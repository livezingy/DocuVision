...
14. [architecture/doc-governance.md](architecture/doc-governance.md) — 文档治理门禁（**DOC-1** 墓碑前缀 / **DOC-2** 路径漂移 / **DOC-3** PENDING 滞留与元数据；规则文本在此，清单真源在 `scripts/docs_refs_audit.py`；晋升自 PENDING P-022（2026-09-25）与 P-025（2026-09-26））
...
- [demo/QUALITY_CASE_STUDY.md](demo/QUALITY_CASE_STUDY.md) — public case study: a silent coordinate bug found by measurement, fixed, and locked by contract tests
